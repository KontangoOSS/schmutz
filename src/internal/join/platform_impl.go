...
const darwinPlistPath = "/Library/LaunchDaemons/io.kontango.tango-tunnel.plist"
...
<plist version="1.0">
<dict>
    <key>Label</key><string>io.kontango.tango-tunnel</string>
...
func (p *DarwinPlatform) ServiceStatus() string {
	if err := exec.Command("launchctl", "list", "io.kontango.tango-tunnel").Run(); err != nil {
		return "not running"
	}
	return "running"
}
